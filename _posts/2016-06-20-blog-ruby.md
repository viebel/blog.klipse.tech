...
This blog post is about to show a new way of bloggin about `ruby`.

Look at a typical blog post aboit `ruby`: The post usually presents a couple of code snippets. As I see it, there are two pains with code snippets:
